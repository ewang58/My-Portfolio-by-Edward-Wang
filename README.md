...
-  In this project, a training dataset and a testing dataset are given. The data contains a 2-dimensional label which denoting the cotton and the polyester content in the fabric respectively. 
